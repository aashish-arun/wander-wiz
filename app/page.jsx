...
export default function Home() {
  const [autoComplete, setAutoComplete] = useState(null); //uses google api
  ...
  const onPlaceChanged = () => {
    if (autoComplete) {
      ...
      console.log("Open now:", place.opening_hours?.isOpen());
    }
  };
  ...
  const handleSubmit = (e) => {
    ...
    // Build URL as a string
    const url = `user/result?destination=${encodeURIComponent(destination)}`;
